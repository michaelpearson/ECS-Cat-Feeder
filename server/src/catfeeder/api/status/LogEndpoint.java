...
public class LogEndpoint {
    ...
    public LogEntryResponse getLogEntries(@QueryParam("maxItems") int maxItems, @PathParam("id") int hardwareId) throws SQLException {
        ...
        List<LogEntry> logEntries = feeder.getLogEntries().stream().limit(maxItems).collect(Collectors.toList());
        return new LogEntryResponse(logEntries);
    }
}
